...
import com.andrewdev.za7ma.Adapters.MessageAdapter;
import com.andrewdev.za7ma.Models.AllMethods;
import com.andrewdev.za7ma.Models.Message;
...
public class GroupChatActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if (item.getItemId() == R.id.menuLogut)
        {
            auth.signOut();
            finish();
